...
@{
    ...
    FunctionsToExport    = @('Export-PFMData', 'Connect-PFMExchange', 'Get-PFMPublicFolderTree', 'Get-PFMPublicFolderStat', 'Get-PFMPublicFolderPermission', 'Get-PFMPublicFolderDatabase', 'Invoke-PFMRemovePublicFolder') #'Get-PFMPublicFolderReplicationReport', 'Set-PFMEmailConfiguration'
