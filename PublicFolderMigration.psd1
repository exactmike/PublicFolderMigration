...
@{
    ...
    FunctionsToExport    = @('Export-PFMData', 'Connect-PFMExchange', 'Get-PFMPublicFolderTree', 'Get-PFMPublicFolderStat', 'Get-PFMPublicFolderPermission', 'Get-PFMPublicFolderDatabase') #'Get-PFMPublicFolderReplicationReport', 'Set-PFMEmailConfiguration'
