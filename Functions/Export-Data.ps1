Function Export-Data
{
    ...
    Write-Information -Message $message -Tags Attempt
    Try
    {
        $formattedData = $(
            switch ($DataType)
    ...
    Catch
    {
        Write-Information -Message "FAILED: Export of $DataToExportTitle as Data Type $DataType to File $ExportFilePath" -Tags Errors
        Write-Information -Message $_.tostring() -Tags Errors
    }#catch
